...
public class JavaStreamsExemplo {
	...
	public static void main(String[] args) {
		...
		//Ordena a lista de geladeiras por pre�o crescente
		Collections.sort(listaGeladeiras, new OrdenaProdutoPorPreco());
		
		//Cria a lista s� de nomes em letras mai�sculas das geladeiras
		...
		//Obt�m um fluxo de dados (stream)
		listaProdutos.stream()
		
		//Interface Predicate - filtrar os nomes dos produtos que cont�m 'Geladeira'
		.filter(p -> p.getNome().contains("Geladeira"))
		
		//Interface Comparator - ordenar o pre�o em ordem crescente de acordo com a implemeta��o da classe OrdenaProdutoPorPreco
